...
%global pkg_name battery_state_rviz_overlay
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-battery-state-rviz-overlay
Version:        1.2.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Jonas Otto <jonas.otto@ipa.fraunhofer.de> - 1.2.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Jonas Otto <jonas.otto@ipa.fraunhofer.de> - 1.2.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Jonas Otto <jonas.otto@ipa.fraunhofer.de> - 1.2.0-1
- Autogenerated by Bloom
